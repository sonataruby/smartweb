...
// Update : https://expressiq.co/update?app=Posts
//==================================================
class Posts extends AdminController
{
	...
	public function index(){
		...
		$this->breadcrumb->add(lang('posts.modules'), $this->link);
		$this->breadcrumb->add(lang('posts.title'), '/index');
	...
	public function create($id=false){
		$this->breadcrumb->add('Dashboard', '/admin');
		$this->breadcrumb->add(lang('posts.modules'), $this->link);
		$this->breadcrumb->add(lang('posts.create'), '/index');
		$this->data['breadcrumbs'] = $this->breadcrumb->render();

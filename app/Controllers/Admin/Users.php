...
// Update : https://expressiq.co/update?app=Users
//==================================================
class Users extends AdminController
{
	...
	public function index(){
		...
		$this->breadcrumb->add(lang('users.modules'), $this->link);
		$this->breadcrumb->add(lang('users.title'), '/index');
	...
	public function create($id=false){
		$this->breadcrumb->add('Dashboard', '/admin');
		$this->breadcrumb->add(lang('users.modules'), $this->link);
		$this->breadcrumb->add(lang('users.create'), '/index');
		$this->data['breadcrumbs'] = $this->breadcrumb->render();

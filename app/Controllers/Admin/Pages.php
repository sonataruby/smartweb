...
// Update : https://expressiq.co/update?app=Pages
//==================================================
class Pages extends AdminController
{
	...
	public function index(){
		...
		$this->breadcrumb->add(lang('pages.modules'), $this->link);
		$this->breadcrumb->add(lang('pages.title'), '/index');
	...
	public function create($id=false){
		$this->breadcrumb->add('Dashboard', '/admin');
		$this->breadcrumb->add(lang('pages.modules'), $this->link);
		$this->breadcrumb->add(lang('pages.create'), '/index');
		$this->data['breadcrumbs'] = $this->breadcrumb->render();

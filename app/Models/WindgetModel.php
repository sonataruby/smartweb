...
//==================================================
class WindgetModel extends BaseModel
{
    // ...
    protected $table      = 'windget';
    ...
    protected $allowedFields = ["keyword","display","short","name","language","format","contents","created_at","deleted_at","updated_at"];

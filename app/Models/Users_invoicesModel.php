...
//==================================================
class Users_invoicesModel extends BaseModel
{
    // ...
    ...
    protected $allowedFields = ["user_id","invoice_id","payment_id","type","status","amount","items","created_at","updated_at"];
